const CusNotificationsIcon = ({ count = 0 }: { count?: number }) => {
  return (
    <div className="relative">
      {count > 0 && (
        <span className="bg-primary-500 absolute right-[3px] h-2 w-2 rounded-full outline outline-2 outline-white" />
      )}
      <svg
        width="24"
        height="24"
...
export default CusNotificationsIcon;
